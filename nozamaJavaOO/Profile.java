...
class Profile extends User{
    ...
    public void menuProfile(){
        boolean aux = true;
        int userChoise, choiseBuy, choiseProduct, choiseMessage;
            ...
            switch(userChoise){
                ...
                case 2: Product e = new Product(this);
                        ...
                        Message m = new Message(this);
                                m.setMessageProduct(this.getUser(), e.toString());
                        ...
                        while(itrProfiles.hasNext()){
                            ...
                            if(p.getFavorito().equals(e.categoria)) p.setMessageBox(m);
                        }
                        break;
                ...
                case 3: if(!this.getMycart().isEmpty()){
                            ...
                            while(itrProducts.hasNext()){
                                ...
                                if(choiseCart == 1){
                                    p.compra();
                                    m.setBuyProduct(this.getUser(), p.getName());
                                    p.owner.setMessageBox(m);
                                } else{
                                    itrProducts.remove();
                ...
                case 5: if(!this.getMessageBox().isEmpty()){
                            ...
                            while(itrMessages.hasNext()){
                                ...
                                System.out.printf(m.toString()+menuMessage);
                                this.choiseMessage = input.nextInt(); input.nextLine();

                                if(choiseMessage == 1){
                                    Message res = new Message(this);
                                    res.setMessage(this.getUser());

                                    m.aux.getMessageBox().add(res);
